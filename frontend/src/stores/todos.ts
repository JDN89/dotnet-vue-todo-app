...
export const useTodoStore = defineStore("todo", {
    ...
    getters: {
        getLists: (state: State) => state.toDoLists,
        getShowAddTask: (state: State) => state.showAddTask,
        getShowAddTodoComponent: (state: State) => state.showAddTodoComp,
        getTemporaryList: (state: State) => state.temporaryList,
    },
});
